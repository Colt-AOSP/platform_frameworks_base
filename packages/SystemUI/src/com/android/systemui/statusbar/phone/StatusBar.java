...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public boolean isCurrentRoundedSameAsFw() {
         ...
         int resourceIdRadius = res.getIdentifier("com.android.systemui:dimen/rounded_corner_colt_radius", null, null);
   ...
   @Nullable
    ...
    protected boolean shouldPeek(Entry entry, StatusBarNotification sbn) {
        ...
        if ((!isDozing() && !mUseHeadsUp) || isDeviceInVrMode() || (!isDozing() && mLessBoringHeadsUp &&
                !isImportantHeadsUp)) {
